...
public class ProductRepository : IProductRepository
{
    ...
    {
        using var connection = _db.CreateConnection();
        var sql = @"INSERT INTO Products (Name, Description, Barcode, CategoryId, Cost, Price, Stock, MinStock) 
                    VALUES (@Name, @Description, @Barcode, @CategoryId, @Cost, @Price, @Stock, @MinStock) RETURNING Id;";
    ...
    public async Task<int> UpdateAsync(Product entity)
    {
        ...
        var sql = @"UPDATE Products SET Name = @Name, Description = @Description, Barcode = @Barcode, 
                    CategoryId = @CategoryId, Cost = @Cost, Price = @Price, Stock = @Stock, MinStock = @MinStock,
