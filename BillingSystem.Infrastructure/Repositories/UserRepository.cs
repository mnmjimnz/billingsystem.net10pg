...
public class UserRepository : IUserRepository
{
    ...
    {
        using var connection = _connectionFactory.CreateConnection();
        var sql = @"INSERT INTO Users (Username, PasswordHash, FullName, RoleId, BranchId, CreatedAt, IsActive, Salary, HireDate, TerminationDate, TerminationReason, JobTitle, DocumentId, BaseBonus, IncomeTaxPercentage, IsAdmin) 
                    VALUES (@Username, @PasswordHash, @FullName, @RoleId, @BranchId, @CreatedAt, @IsActive, @Salary, @HireDate, @TerminationDate, @TerminationReason, @JobTitle, @DocumentId, @BaseBonus, @IncomeTaxPercentage, @IsAdmin) RETURNING Id;";
    ...
    {
        using var connection = _connectionFactory.CreateConnection();
        var sql = @"UPDATE Users SET Username = @Username, FullName = @FullName, RoleId = @RoleId, BranchId = @BranchId, UpdatedAt = @UpdatedAt, IsActive = @IsActive, Salary = @Salary, HireDate = @HireDate, TerminationDate = @TerminationDate, TerminationReason = @TerminationReason, JobTitle = @JobTitle, DocumentId = @DocumentId, BaseBonus = @BaseBonus, IncomeTaxPercentage = @IncomeTaxPercentage, IsAdmin = @IsAdmin WHERE Id = @Id;";
